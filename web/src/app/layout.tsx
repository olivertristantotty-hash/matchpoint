    ...
    <html lang="en">
      <body>
        <nav style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
            <a
              ...
              style={{
                fontSize: "11px", color: "var(--text-muted-dark)", textDecoration: "none",
          ...
          {/* Right — Nav links */}
          <div style={{ display: "flex", gap: "28px", alignItems: "center", fontSize: "14px", justifyContent: "flex-end" }}>
            {isLoggedIn ? (
              <>
        ...
        <footer style={{
          ...
          color: "var(--text-muted-dark)", fontSize: "12px",
          display: "flex", justifyContent: "center", gap: "20px",
        }}>
          <a href="/terms" style={{ color: "var(--text-muted-dark)", fontSize: "12px" }}>Terms</a>
          <a href="/privacy" style={{ color: "var(--text-muted-dark)", fontSize: "12px" }}>Privacy</a>
          <a href="/fair-play" style={{ color: "var(--text-muted-dark)", fontSize: "12px" }}>Fair Play</a>
        </footer>
      </body>
    </html>
  );
